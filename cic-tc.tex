...
\begin{enumerate}
    ...
    \item Executado algoritmo do ODL, conforme o algoritmo \autoref{algo:odl}.
\end{enumerate}
...
Ao observar o algoritmo OMP (\autoref{algo:omp}), verifica-se que sua complexidade teórica 
...
de 16bit, com exceção da classe cartoon, que manteve uma considerável variação.
...
Apesar da percepção de que se alcança maior estabilidade utilizando 16bit na quantização, 
...
% Tabela do bitrate
\begin{table}[h]
    \caption{Bitrate calculado para vídeos de teste com $p=8$, $K=192$ e $s=14$.}
    \centering
