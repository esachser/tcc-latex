...
ao codec.
Os resultados discutidos apresentam visualmente erros gerados nos quadros gerados 
pelo codec proposto,
...
Considere um quadro 720p usando $p=4$, utilizando $1$ byte para o valor e $1$ para o índice em cada 
