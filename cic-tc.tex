...
\begin{figure}[H]
    \caption{Tempo médio por frame para patches $4\times4$.}
    \begin{center}
...
\begin{figure}[H]
    \caption{Tempo médio por frame para patches $8\times8$.}
    \begin{center}
...
\begin{figure}[H]
    \caption{PSNR médio em função do tamanho do dicionário, com quantização de 16 bits.}
    \begin{center}
...
\begin{figure}[H]
    \caption{Fundo de cena do vídeo johnny, tamanho do dicionário $K=32$, esparsidade $s=5$ e patches $4\times4$,
    quantizado 8 bits.
    (a) Referência. 
...
\begin{figure}[H]
    \caption{Vídeo big\_buck\_bunny, tamanho do dicionário $K=16$, esparsidade $s=5$ e patches $4\times4$, 
    quantizado 8 bits. 
    (a) Referência. 
    (b) Resultado com codec proposto.}
    \begin{center}
