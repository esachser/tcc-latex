...
Por ser um \textit{framework} com foco em tempo real, naturalmente se põe em questão 
...
com linha a linha, ou seja, primeiro a linha $0$, depois a $1$, e assim por diante.
Em contraste com essa definição poderíamos ter a imagem coluna por coluna, o que alteraria
alguns cálculos internos, mas é possível adaptar o sistema desenvolvido de forma bastante simples.
