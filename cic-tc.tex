...
Entende-se, nessa etapa, que o frame já está disponível, no formato de imagem colorida,
pixel a pixel, RGB. Ou seja, a entrada para essa etapa é um frame $m \times n \times 3$,
...
alguns cálculos internos, mas é possível adaptar o sistema de forma bastante simples.
...
Valor típicos a serem escolhidos são $p=4$ ou $p=8$. No capítulo \ref{sec:results} serão 
