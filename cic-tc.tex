...
Muitos sinais de interesse possuem menos informação do que a dimensão do ambiente sugere \cite{chen2015compressed}.
...
O modelo de \textit{Compressed Sensing (CS)} surgiu com esse intuito. Trabalhos na área mostram que, para certas classes
...
$\hat{f}_s$:
$$ \lVert \hat{f} - \hat{f}_s \rVert_2 \le Rs^{\frac{1}{2} - \frac{1}{q}} \text{ e,}$$
